...
public class Main {
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // o(n^2) where n is length of wordsA + length of  wordsB
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // o(n) where n is the size of the two lists combined.
  ...
  // o(n) where n is length of names.
  ...
  // O(n^2) where n is the lenght of wordSet
